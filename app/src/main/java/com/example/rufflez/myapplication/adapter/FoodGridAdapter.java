...
/**
 * Created by HoangLong on 6/29/2017.
 */


public class FoodGridAdapter extends ArrayAdapter<String> {
    ...
    public View getView(final int position, View convertView,
        ...
        ViewHolder vh;
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_food_grid_view,
                    parent, false);
            vh = new ViewHolder();
