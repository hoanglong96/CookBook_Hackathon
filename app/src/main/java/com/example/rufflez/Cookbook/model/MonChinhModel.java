...
public class MonChinhModel implements Serializable {
    //    private int id;
    ...
    public MonChinhModel(String typyFood, String avatarFood, String titleFood, String ingredientFood, String methodFood) {
//        this.id = id;
