...
public class MonChinhAdapter extends RecyclerView.Adapter<MonChinhAdapter.ViewHolder> {
    private Context context;
    private List<MonChinhModel> singleItemModelList;

    public MonChinhAdapter(Context context, List<MonChinhModel> foodModelList) {
